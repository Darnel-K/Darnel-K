<?php
    ...
    if ($CONN['Connection']->query($SQL)->num_rows <= 0) {
        ...
        $SQL = "INSERT INTO Fingerprint_Data (FingerprintID, User_Agent, Language, Color_Depth, Pixel_Ratio, Hardware_Concurrency, Resolution, Available_Resolution, Timezone_Offset, Session_Storage, Local_Storage, Indexed_DB, Open_Database, CPU_Class, Navigator_Platform, Regular_Plugins, Canvas, WebGL, AdBlock, Has_Lied_Languages, Has_Lied_Resolution, Has_Lied_OS, Has_Lied_Browser, Touch_Support, JS_Fonts, First_Visit_Date, WebGL_Vendor, Do_Not_Track) VALUES ('{$Data['FP']}', '{$Data['FP_Data']['user_agent']}', '{$Data['FP_Data']['language']}', '{$Data['FP_Data']['color_depth']}', '{$Data['FP_Data']['pixel_ratio']}', '{$Data['FP_Data']['hardware_concurrency']}', '{$Data['FP_Data']['resolution']}', '{$Data['FP_Data']['available_resolution']}', '{$Data['FP_Data']['timezone_offset']}', '{$Data['FP_Data']['session_storage']}', '{$Data['FP_Data']['local_storage']}', '{$Data['FP_Data']['indexed_db']}', '{$Data['FP_Data']['open_database']}', '{$Data['FP_Data']['cpu_class']}', '{$Data['FP_Data']['navigator_platform']}', '{$Data['FP_Data']['regular_plugins']}', '{$Data['FP_Data']['canvas']}', '{$Data['FP_Data']['webgl']}', '{$Data['FP_Data']['adblock']}', '{$Data['FP_Data']['has_lied_languages']}', '{$Data['FP_Data']['has_lied_resolution']}', '{$Data['FP_Data']['has_lied_os']}', '{$Data['FP_Data']['has_lied_browser']}', '{$Data['FP_Data']['touch_support']}', '{$Data['FP_Data']['js_fonts']}', '{$Data['FP_Data']['Date']}', '{$Data['FP_Data']['webgl_vendor']}', '{$Data['FP_Data']['do_not_track']}')";
